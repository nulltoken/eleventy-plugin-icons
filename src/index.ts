...
export default function (
	...
	eleventyConfig.addTransform(
		...
		async function (
			...
			if (generationMode === GenerationMode.Embedded) {
				let pageSpritesheet: string | undefined = undefined;

				if (this.page.icons !== undefined) {
					pageSpritesheet = await createSpriteWithExtraIcons(
	...
	eleventyConfig.addShortcode(
		...
		function (
			this: { page: { icons: Map<string, Icon> | undefined } },
			input: any,
			...
			addIfMissing(this.page.icons, icon);
	...
	const getWrittenSpriteRelativeUrl = async (
		...
		if (generationMode === GenerationMode.HashedBundle) {
